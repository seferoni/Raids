...
this.edict_of_abundance <- ::inherit("scripts/items/special/edict_item",
{
	...
	function create()
	{
		...
		this.m.Value = 50;
		this.m.EffectText <- "Will induce nearby lairs to stock moderately greater quantities of food, medical supplies, tools, and treasure in their inventories. This edict's effects are permanent.";
	}
});