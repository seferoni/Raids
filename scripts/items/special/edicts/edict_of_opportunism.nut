...
this.edict_of_opportunism <- ::inherit("scripts/items/special/edict_item",
{
	...
	function create()
	{
		...
		this.m.Value = 50;
        this.m.EffectText <- "Will induce nearby lairs to reassess their inventories and potentially keep more Famed items on hand. This edict's effects are temporary.";
	}
});