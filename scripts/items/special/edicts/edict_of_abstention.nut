...
this.edict_of_abstention <- ::inherit("scripts/items/special/edict_item",
{
	...
	function create()
	{
		...
		this.m.Value = 50;
		this.m.EffectText <- "Will force nearby lairs into hiding, thereby clearing the roads and allowing for the closest settlement to prosper for a time. This edict's effects are temporary.";
	}
});