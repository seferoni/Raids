::Raids.Strings.Lairs.Traits <-
{
	...
	MarksmenDescription = "This lair's retinue is host to a number of skilled marksmen.",

	MarksmenSouthernName = "Marksmen",
	MarksmenSouthernDescription = "This lair's retinue is host to a number of skilled marksmen.",

	MercenaryKnightsName = "Mercenary Knights",
	MercenaryKnightsDescription = "Itinerant knights, beggared and made bandits by a lull in the conflicts of the realm, roost in this lair.",

	NecromancyName = "Necromancy",
	NecromancyDescription = "The denizens of this lair have taken to cavorting with dark forces beyond their ken.",

	NobleDesertersName = "Deserters",
	NobleDesertersDescription = "Once-loyal servants of the realm have resorted to banditry within this region to make ends meet.",

	NobleDesertersSouthernName = "Deserters",
	NobleDesertersDescription = "Once-loyal servants of the realm have resorted to banditry within this region to make ends meet.",

	NorthernExilesName = "Northern Exiles",
	NorthernExilesDescription = "A wandering band of vagrant northmen, uprooted from their ancestral home, have taken up residence here."

	OrcAllianceName = "Orc Alliance",
	OrcAllianceDescription = "These crafty goblins have enlisted the aid of powerful orcish men-at-arms.",

	PeasantRevoltName = "Peasant Revolt",
	PeasantRevolutionDescription = "Unjust law and exorbitant taxes have rendered these paupered peasants little more than starved brigands.",
