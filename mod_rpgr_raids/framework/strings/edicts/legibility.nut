::Raids.Strings.Edicts.Legibility <-
{
	...
	WarningFragmentC = "Edicts of Legibility target lairs occupied by factions such as %s.",
	WarningFragmentD = "goblins, orcs, and ancient undead",
};